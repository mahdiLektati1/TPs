...
class Deck extends Component {
    ...
    isValidDeck() {
        this.props.handleValidDeck();
    }

    showValidate() {
        return (
            this.validateDeck() ? < button type = "button" className = "btn btn-primary mt-2" onClick = { this.isValidDeck.bind(this) } > J 'ai fini!</button> : ""
        )
    }
                    ...
                    <div class = "row" >
                        ...
                        <div className = "col-6 bg-secondary rounded" >
                            <div className = "row text-center" >
                                ...
                                <div className = "col-4 text-center" > { this.showValidate() } </div> 
